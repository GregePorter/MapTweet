...
?>
<p>To complete the OAuth flow please <a href="<?php echo $url ?>">click here</a></p>
<?php
  }
}
...
function access_token($tmhOAuth) {
  ...
  if ($code == 200) {
    ...
    setcookie("access_token", $oauth_creds["oauth_token"], time()+3600*24*30);  
    setcookie("access_token_secret", $oauth_creds["oauth_token_secret"], time()+3600*24*30);
